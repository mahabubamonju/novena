...
<head>
  ...
  <link href="{{asset('/')}}backend-assets/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
  <link href="{{asset('/')}}backend-assets/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
  <!-- Bootstrap CSS -->
  ...
  <link rel="stylesheet" href="{{asset('/')}}backend-assets/assets/npm/bootstrap-icons%401.5.0/font/bootstrap-icons.css">
