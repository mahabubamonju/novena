	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="{{asset('/')}}frontend-assets/images/about/img-1.jpg" alt="" class="img-fluid">
					<img src="{{asset('/')}}frontend-assets/images/about/img-2.jpg" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="{{asset('/')}}frontend-assets/images/about/img-3.jpg" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
                        ...
                        <div class="latest-product">
                            ...
                            <div class="product-carousel">
                                ...
                                <div class="single-product">
                                    ...
                                    <h5 class="text-primary mb-3">{{ $product->price }}TK</h5>
                                    <h5 class="text-primary mb-3">{{ $product->desc }}</h5>
                                    <h1> <a href="" class="btn btn-outline-primary btn-warning px-3">See Details</a>
                                    </h1>
                                </div>
                                @endforeach
                            </div>
			...
			<div class="col-lg-12 testimonial-wrap-2">
				<div class="testimonial-block style-2  gray-bg">
					...
					<div class="testimonial-thumb">
						<img src="{{asset('/')}}frontend-assets/images/team/test-thumb1.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/')}}frontend-assets/images/team/test-thumb2.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/')}}frontend-assets/images/team/test-thumb3.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="testimonial-block style-2  gray-bg">
					<div class="testimonial-thumb">
						<img src="{{asset('/')}}frontend-assets/images/team/test-thumb4.jpg" alt="" class="img-fluid">
					</div>
		...
		<div class="row clients-logo">
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/1.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/2.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/3.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/4.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/5.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
					<img src="{{asset('/')}}frontend-assets/images/about/6.png" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-2">
				<div class="client-thumb">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="service-item mb-4">
                        <div class="mb-3">
                            <a href=""><img src="{{$product->image}}" alt="" height="400px" width="90%" class="ml-4"></a>
                        </div>
                        <div>
                            <a href=""><h3 class="ml-4">{{$product->name}}</h3></a>
                        </div>
						<div class="icon d-flex align-items-center">
							<i class="icofont-laboratory text-lg"></i>
							<h4 class="mt-3 mb-3">Latest Products</h4>
						</div>

                        <button class="btn btn-success ml-4"><a href="">Details</a></button>
                    </div>
					{{-- <div class="product-carousel">
						 
						<div class="single-product" style="margin:left" >
							<div class="product-f-image">
								<img class="img-fluid mb-4" src="{{ asset('/') }}/{{ $product->image }}" alt="">
							</div>
							<h2><a href="single-product.html">{{ $product->name }}</a></h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12 testimonial-wrap-2">
                    <div class="testimonial-block style-2  gray-bg">
                        ...
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}frontend-assets/images/team/test-thumb1.jpg" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('/') }}frontend-assets/images/team/test-thumb3.jpg" alt=""
                                class="img-fluid">
                        </div>
