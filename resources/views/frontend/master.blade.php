...
<head>
  ...
  <!-- Icon Font Css -->
  <link rel="stylesheet" href="{{asset('/')}}frontend-assets/plugins/icofont/icofont.min.css">
  <!-- Slick Slider  CSS -->
...
@include('frontend.includes.footer')
    ...
    <!-- Main jQuery -->
    <script src="{{asset('/')}}frontend-assets/plugins/jquery/jquery.js"></script>
    <!-- Bootstrap 4.3.2 -->
    <script src="{{asset('/')}}frontend-assets/plugins/bootstrap/js/popper.js"></script>
    <script src="{{asset('/')}}frontend-assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="{{asset('/')}}frontend-assets/plugins/counterup/jquery.easing.js"></script>
    <!-- Slick Slider -->
    <script src="{{asset('/')}}frontend-assets/plugins/slick-carousel/slick/slick.min.js"></script>
    <!-- Counterup -->
    <script src="{{asset('/')}}frontend-assets/plugins/counterup/jquery.waypoints.min.js"></script>
    ...
    <!-- Google Map -->
    <script src="{{asset('/')}}frontend-assets/plugins/google-map/map.js"></script>
